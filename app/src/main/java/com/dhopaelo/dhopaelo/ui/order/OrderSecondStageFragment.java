...
import static com.dhopaelo.dhopaelo.ui.order.OrderActivity.DELIVERY_INFO;
import static com.dhopaelo.dhopaelo.ui.order.OrderActivity.FROM_FRAGMENT_NAME;
import static com.dhopaelo.dhopaelo.ui.order.OrderActivity.INVOICE_DATA;
...
import com.dhopaelo.dhopaelo.databinding.AddressEditBinding;
import com.dhopaelo.dhopaelo.databinding.FragmentOrderSecondStageBinding;
import com.dhopaelo.dhopaelo.databinding.InvoiceItemViewBinding;
...
import com.dhopaelo.dhopaelo.util.OrderModelConstant;
...
//            double totalPrice = 0;
        ...
        binding.placeOrderBtn.setOnClickListener(v -> {
            ...
            if (pendingItemKey.equals("")) {
                ...
                //Toast.makeText(getContext(), "Please Enable Internet First", Toast.LENGTH_SHORT).show();
            } else {
                addNameField();
